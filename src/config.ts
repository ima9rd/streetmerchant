...
const notifications = {
	...
	discord: {
		...
		notifyGroupSeries: {
			...
			eliteexp: envOrArray(process.env.DISCORD_NOTIFY_GROUP_ELITE_EXP), 
			proexp: envOrArray(process.env.DISCORD_NOTIFY_GROUP_PRO_EXP), 
			...
			selecttech1090: envOrArray(process.env.DISCORD_NOTIFY_GROUP_SELECTTECH_1090),
...
const store = {
	...
	maxPrice: {
		series: {
			...
			eliteexp: envOrNumber(process.env.MAX_PRICE_SERIES_ELITE_EXP),
			proexp: envOrNumber(process.env.MAX_PRICE_SERIES_PRO_EXP),
			...
			selecttech1090: envOrNumber(process.env.MAX_PRICE_SERIES_SELECTTECH_1090),
